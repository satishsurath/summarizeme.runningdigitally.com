...
**M18** `.github/workflows/main_summarize-me.yml:41` — Deploy uses host-specific path `/home/<operator>/.env`. Not portable.
...
### Major
**M19** `.github/workflows/main_summarize-me.yml:41` — Deploy passes `--env-file=/home/<operator>/.env` with production secrets. Not portable.
